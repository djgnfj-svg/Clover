...
export const clubList = 'http://127.0.0.1:8000/api/clubs/' // 전체 클럽 리스트
export const applyClub = 'http://127.0.0.1:8000/api/clubs/joinclubs/' // 클럽 가입 
export const ExitCluburl = `http://127.0.0.1:8000/api/clubs/outclubs/` // 클럽 탈퇴
...
export const clubinfoImgUrl = (id) => `http://127.0.0.1:8000/api/clubs/${id}/img/`
export const clubRankUrl = (id) => `http://127.0.0.1:8000/api/clubs/${id}/master/appointManager/`  // 유저 운영진 < - > 유저 등급
